    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('admin.autors.create') }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded shadow-lg transition duration-150 ease-in-out">
                    + Afegir Autor
                </a>
            </div>
            ...
            <div x-data="{ show: true }"
                ...
                role="alert">
                <strong class="font-bold">Fet!</strong>
