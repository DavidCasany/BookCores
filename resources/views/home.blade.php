...
<body class="antialiased bg-slate-50 text-slate-800">
    ...
    <main>
        <div class="relative bg-white overflow-hidden">
           ...
           <div class="relative w-full h-[450px] lg:h-full lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-slate-900 overflow-hidden z-0">
            ...
            <div class="w-full h-full"
                ...
                <div class="flex h-full w-full will-change-transform"
                    ...
                    <div class="relative w-full h-full flex-shrink-0 flex items-center justify-center bg-slate-900">
                        <template x-if="books[0]">
                            <div class="contents">
                                <template x-if="books[0].img">
                                    <img :src="books[0].img" 
                                         :alt="books[0].titol" 
                                         class="h-[85%] w-auto object-contain drop-shadow-2xl shadow-black/60 rounded-md">
                                </template>
